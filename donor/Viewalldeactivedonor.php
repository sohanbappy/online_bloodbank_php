 ...
 $target_page=0;
    ...
    else
    {
      $target_page = ($get_page*2)-2;
       ...
       $query = "SELECT * FROM donor_tb WHERE activity = 'deactive' AND status = 'Accepted' limit $target_page,2 ";
...
<?php
  $query3 = "SELECT * FROM donor_tb WHERE activity = 'deactive' AND status = 'Accepted' ";
...
{
 ?> <a href="http://localhost/EUDV/donor/Viewalldeactivedonor.php?page=<?php echo $target;?>"> <?php echo "<span style='font-size:25px'  >$target </span> &nbsp &nbsp &nbsp" ?></a> <?php
