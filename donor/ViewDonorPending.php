...
include "../function/Database.php";
 ...
 $target_page=0;
    ...
    $query = "SELECT * FROM donor_tb WHERE status ='Pending' ORDER BY donor_id  limit $target_page,2 ";
...
<a href="http://localhost/EUDV/allDonorReportPending.php" class="btn btn-success">ALL Pending Pdf</a>


<!-- <button class="btn btn-warning" onclick="printContent('pend')">Print</button> -->
...
<?php
$query3 = "SELECT * FROM donor_tb WHERE status ='Pending' ";
...
{
 ?> <a href="http://localhost/EUDV/donor/ViewDonorPending.php?page=<?php echo $target;?>"> <?php echo "<span style='font-size:25px'  >$target </span> &nbsp &nbsp &nbsp" ?></a> <?php
