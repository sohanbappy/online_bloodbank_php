...
<li><a href="http://localhost/EUDV/donorHome.php" > Home </a></li>
<li><a href="http://localhost/EUDV/donor/ViewRequest.php" >Manage Request</a></li>
<li><a href="http://localhost/EUDV/donor/UpdateDonor.php?donor_id=<?php echo $_SESSION['usl'] ?>" >Edit Profile</a></li>
<li><a href="http://localhost/EUDV/ViewDonorDonation.php" >Manage Donation</a></li>

<li><a href="http://localhost/EUDV/donor/ViewAcceptedReq.php" >View Accepted Request</a></li>

<li><a href="http://localhost/EUDV/logOut.php">Logout</a></li>
