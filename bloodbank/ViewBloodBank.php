...
include "../function/Database.php";
   ...
   $query = "SELECT * FROM blood_bank_tb ORDER BY bank_id  limit $target_page,2 ";
    $read = $db->select($query);
...
<a href="http://localhost/EUDV/bloodbank/ViewBloodBankPending.php?page=1" class="btn btn-warning">View Pending Bloodbank</a>





<center><h2><b> View Organization Information</b></h2></center>
...
<?php
$query3 = "SELECT * FROM blood_bank_tb WHERE status = 'Accepted'" ;
...
{
 ?> <a href="http://localhost/EUDV/bloodbank/ViewBloodBank.php?page=<?php echo $target;?>"> <?php echo "<span style='font-size:25px'  >$target </span> &nbsp &nbsp &nbsp" ?></a> <?php
